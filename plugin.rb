...
# about: Adds the ability to create static pages for Discourse and redirects both root URL and main logo to /page/home/10
# version: 0.1
...
after_initialize do
  # 1) 루트 URL (/) 접근 시 /page/home/10으로 리디렉션
  Discourse::Application.routes.prepend do
    get "/" => redirect("/page/home/10")
  end

  # 2) 기존 procourse-static-pages 플러그인 라우트 설정 유지
